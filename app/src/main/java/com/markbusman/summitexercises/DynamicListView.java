...
import com.markbusman.summitexercises.StableArrayAdapter;
...
public class DynamicListView extends ListView {
    ...
    private boolean itemsWhereSwapped = false;

    private final int SMOOTH_SCROLL_AMOUNT_AT_EDGE = 15;
    private final int MOVE_DURATION = 150;
    private final int LINE_THICKNESS = 15;

    private ArrayList<Exercises> mDataList;
    ...
    private ListRefreshedListener listener;
    ...
    public void init(Context context) {
        ...
        this.itemsWhereSwapped = false;
    }


    /**
     * Custom Listener to alert when table is refreshed
     */
    ...
    public void setListRefreshedListener(ListRefreshedListener listener) {
        ...
        if (mCellIsMobile|| mIsWaitingForScrollFinish) {
            ...
            hoverViewAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    if (itemsWhereSwapped) {
                        if (listener != null) {
                            listener.listRefreshed();
                        }
                    }

                    itemsWhereSwapped = false;
                }
            });
    ...
    public void setDataList(ArrayList<Exercises> dataList) {

        mDataList = dataList;
    }

    public ArrayList<Exercises> getDataList() {
        return mDataList;
    }
    ...
    public void updateDataItem(Exercises exercise, int position) {
        mDataList.set(position, exercise);
    }
